...
class Bot:
    ...
    def send_audio(
        ...
        """
        return self.send_attachment(
            recipient_id, "audio", audio_path, notification_type
        )
    ...
    def remove_get_started(self):
        ...
        response = requests.delete(
            request_endpoint, params=self.auth_args, json=delete_obj
        )
        result = response.json()
        return result
    ...
    def send_text_quick_replies(self, recipient_id, message, quick_replies):
        """
